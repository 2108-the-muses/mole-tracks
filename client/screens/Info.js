...
const Info = () => {
  ...
  const blurb2 =
    ...
    const disclaimer = "DISCLAIMER: THIS APP DOES NOT PROVIDE MEDICAL ADVICE. The information, including but not limited to, text, graphics, images and other material contained on this application are for informational purposes only. No material on this application is intended to be a substitute for professional medical advice, diagnosis or treatment. Always seek the advice of your physician or other qualified health care provider with any questions you may have regarding a medical condition or treatment and before undertaking a new health care regimen, and never disregard professional medical advice or delay in seeking it because of something you have read on this application.";
    ...
    <View style={styles.containerCenter}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ margin: 5 }}>
        ...
        <View style={styles.containerInfoTags}>
          ...
          />
          <Text style={{ ...styles.fontMedium, flex: 1, alignSelf: "center" }}>
        ...
        <View style={styles.containerInfoTags}>
          ...
          />
          <Text style={{ ...styles.fontMedium, flex: 1, alignSelf: "center" }}>
            The mole has different colors or it has shades of tan, brown, black,
            blue, white, or red
          </Text>
        </View>
        ...
        <View style={styles.containerInfoTags}>
          ...
          />
          <Text style={{ ...styles.fontMedium, flex: 1, alignSelf: "center" }}>
            The diameter of the mole is larger than the eraser of a pencil (6mm)
          </Text>
        </View>
        ...
        <Text style={styles.fontMedium}>{disclaimer}</Text>
      </ScrollView>
    </View>
  );
};
